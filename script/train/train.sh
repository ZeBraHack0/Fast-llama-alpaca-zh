...
setup () {
    ...
    echo_back "cd Chinese-LLaMA-Alpaca"
    echo_back "git checkout 7bc1f3d7c426e3685d14eb1e5614066650f94838"
    echo_back "cd ../"
...
pretrain_lora() {
    ...
    echo_back "cp ds_zero3_offload_pt.json ${script_dir}"
...
finetune_lora() {
    ...
    echo_back "cp ds_zero3_offload_sft.json ${script_dir}"
